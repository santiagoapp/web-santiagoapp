		 ...
		 <div class="footer-bottom">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<ul class="site-info">
						<?php if( !empty( $minimal_portfolio_footer_facebook_link ) ||  !empty( $minimal_portfolio_footer_twitter_link ) || !empty( $minimal_portfolio_footer_google_plus_link ) || !empty( $minimal_portfolio_footer_youtube_link ) ): ?>
							...
							<li class="copyright">
    							...
    							<?php endif; ?>
								<a href="<?php echo esc_url( __( 'https://santiagoapp.com/', 'minimal-portfolio' ) ); ?>"><?php printf( esc_html__( 'Designed by %s', 'minimal-portfolio' ), 'Santiago Pereira' ); ?></a>
							</li>
							<?php endif; ?>
						</ul>
					</div>

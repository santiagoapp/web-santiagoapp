...
function minimal_portfolio_scripts() {
	...
	if ( $template == 'single-resume.php') {
		...
		wp_enqueue_script( 'resuem-jquery', get_template_directory_uri() . '/assets/resume/js/jquery.min.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_script( 'resuem-jquery-migrate', get_template_directory_uri() . '/assets/resume/js/jquery-migrate-3.0.1.min.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_script( 'resuem-popper', get_template_directory_uri() . '/assets/resume/js/popper.min.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_script( 'resuem-bootstrap', get_template_directory_uri() . '/assets/resume/js/bootstrap.min.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_script( 'resuem-jquery-easing', get_template_directory_uri() . '/assets/resume/js/jquery.easing.1.3.js', array( 'jquery' ), '1.0', true );
		wp_enqueue_script( 'resuem-jquery-waypoints', get_template_directory_uri() . '/assets/resume/js/jquery.waypoints.min.js', array( 'jquery' ), '1.0', true );
